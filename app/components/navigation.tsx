...
export function PublicNavigation() {
  return (
    <nav className="relative flex h-[80px] min-h-[80px] items-center justify-between md:h-[100px] md:min-h-[100px]">
      <Link to="/" className="flex h-8 items-center gap-2">
        <span className="text-lg font-medium text-gray-600">
          Remix Auth <span className="font-extrabold text-gray-800">TOTP</span>
        </span>
        <span className="inline-flex items-center justify-center rounded-md border border-gray-200 px-2 text-base font-bold text-gray-800">
          v4.0
        </span>
      </Link>
